...
import com.asialjim.microapplet.remote.config.RemoteLocalEnvironment;
import com.asialjim.microapplet.remote.net.event.ApiServerEnvironmentLockedEvent;
...
@Component
public class ApiServerMyBatisPlusRepository implements ApiServerRepository, ApplicationContextAware {
