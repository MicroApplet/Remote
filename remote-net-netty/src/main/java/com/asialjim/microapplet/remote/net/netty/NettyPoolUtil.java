 ...
 */
package com.asialjim.microapplet.remote.net.netty;
...
public class NettyPoolUtil {
    ...
    public static void releaseChannel(ChannelHandlerContext ctx) {
        ...
        try {
            RemoteNettyChannelContext nettyHttpRequestContext = ctx.channel().attr(RemoteNettyChannelContext.CURRENT_REQ_BOUND_WITH_THE_CHANNEL).get();
