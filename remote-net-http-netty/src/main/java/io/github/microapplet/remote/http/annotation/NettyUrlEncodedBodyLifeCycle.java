...
import io.github.microapplet.remote.http.annotation.body.UrlEncodedBody;
import io.github.microapplet.remote.http.client.NettyRemoteHTTPClient;

/**
 * 基于 Netty 的HTTP x-www-urlencoded 请求体处理器
 *
...
public class NettyUrlEncodedBodyLifeCycle extends UrlEncodedBody.EncodedBodyLifeCycle {
    ...
    protected void doBefore(Object data, RemoteMethodConfig methodConfig, RemoteReqContext req, RemoteResContext res, Object[] args) {
        NettyRemoteHTTPClient.addStringContentBuffer(req);
    }
}