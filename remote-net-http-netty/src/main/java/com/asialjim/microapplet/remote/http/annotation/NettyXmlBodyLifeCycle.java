...
import com.asialjim.microapplet.remote.http.annotation.body.XmlBody;

@Primary
@RemoteSubProperty("netty")
public class NettyXmlBodyLifeCycle extends XmlBody.XmlBodyLifeCycle {
    @Override
