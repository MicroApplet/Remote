 ...
 */
public final class ApplicationJsonRemoteNetResponseParser extends BaseRemoteNetResponseParser {
    public static final BaseRemoteNetResponseParser INSTANCE = new ApplicationJsonRemoteNetResponseParser();
    private static final Logger log = LoggerFactory.getLogger(ApplicationJsonRemoteNetResponseParser.class);
