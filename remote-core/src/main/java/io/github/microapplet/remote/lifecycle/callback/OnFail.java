 ...
 */
@FunctionalInterface
public interface OnFail extends CallBack {

    /**
     * 当回调方法 SuccessWhen#success(Object, RemoteReqContext, RemoteResContext, Object[]) 执行返回 false 时，回调此接口
     *
     * @param data 相应结果
     * @param req  Remote 请求上下文
     * @param res  Remote 相应上下文
     */
    void onFail(Object data, RemoteMethodConfig methodConfig, RemoteReqContext req, RemoteResContext res, Object[] args);
}
