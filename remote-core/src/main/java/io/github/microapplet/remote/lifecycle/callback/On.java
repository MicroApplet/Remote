 ...
 * @version 1.0
 * @since 2022/12/6, &nbsp;&nbsp; <em>version:1.0</em>, &nbsp;&nbsp; <em>java version:8</em>
 */
@FunctionalInterface
public interface On extends CallBack {

    /**
     * 回调函数，任何情况下，都会回调此函数
     */
    void on(Object data, RemoteMethodConfig methodConfig, RemoteReqContext req, RemoteResContext res, Object[] args);
}
