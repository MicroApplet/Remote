 ...
 */
@FunctionalInterface
public interface RetryWhen extends CallBack {
     ...
     */
    boolean retryWhen(Object data, RemoteMethodConfig methodConfig, RemoteReqContext req, RemoteResContext res, Object[] args);
}
