 ...
 */
@FunctionalInterface
public interface SuccessWhen extends CallBack {
    ...
    boolean success(Object data, RemoteMethodConfig methodConfig, RemoteReqContext req, RemoteResContext res, Object[] args);
}